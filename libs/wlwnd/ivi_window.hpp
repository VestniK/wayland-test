...
public:
  ...
  window(wl_compositor& compositor, ivi_application& shell, uint32_t ivi_id, delegate* delegate = nullptr);
...
private:
  static void configure(void* data, ivi_surface* ivi_surface, int32_t width, int32_t height);
