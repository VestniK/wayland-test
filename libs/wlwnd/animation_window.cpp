...
struct animation_window::impl : public xdg::delegate {
  impl(co::pool_executor exec, event_queue& queue, wl_surface& surf,
      size initial_size, animation_function render_func)
...
animation_window::animation_window(event_queue queue,
    co::pool_executor pool_exec, wl::sized_window<wl::shell_window>&& wnd,
...
animation_window& animation_window::operator=(
