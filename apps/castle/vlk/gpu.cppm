...
export class device_queue_families {
public:
...
export gpu select_suitable_device(vk::raii::Instance inst, vk::SurfaceKHR surf, vk::Extent2D sz);
...
gpu::gpu(vk::raii::Instance&& inst, vk::raii::PhysicalDevice&& dev, device_queue_families families)
    : instance_{std::move(inst)}, phydev_{std::move(dev)}, device_{create_logical_device(phydev_, families)},
      families_{families}, alloc_{vma_allocator::create(*instance_, *phydev_, *device_)} {}
